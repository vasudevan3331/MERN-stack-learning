class ProductData {
 ...
 class RenderSingleProduct {
     ...
     renderProd(ele) {
         ...
         function handleclick() {
            alert ("our order placed sucessfully")
         }
 ...
 class ProductList extends Component {
     ...
     fetchProducts() {
         return [
            new ProductData("chicken briyani","chicken",300,"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTuWkqR087ENNtJpkaDYBJ5iZx7BeaUJXfjzA&s"),
            new ProductData("mutto n briyani","nuturalspice",500,"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQxOpnvxXd86zlg7hOQdUkAMACbhyzrUKJMGA&s"),
            new ProductData("special briyani","infuse-chicken",900,"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSFZZQ9aZrvtblqL07C07ARWy8Di-Tyrq_LMQ&s"),
         ]
     }
